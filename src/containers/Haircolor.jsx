  ...
  return (
    <div className="py-6 px-4 md:px-8 lg:px-12 max-w-full mx-auto">
      ...
      <div className="relative mb-8" data-aos="fade-up" data-aos-delay="900">
            ...
            <p className="text-base md:text-lg text-primaryDark text-start mb-4">We have received over 1,200 appointments for hair coloring services this year.</p>
            <div className="relative flex justify-center py-6">
                <div className="absolute w-12 h-12 rounded-full border-4 border-white bg-gray-100 flex items-center justify-center overflow-hidden" style={{ left: '0', zIndex: 3 }}>
                <img src={personImage1} alt="Person 1" className="w-full h-full object-cover rounded-full" />
                </div>
                <div className="absolute w-12 h-12 rounded-full border-4 border-white bg-gray-100 flex items-center justify-center overflow-hidden" style={{ left: '20px', zIndex: 2 }}>
                <img src={personImage2} alt="Person 2" className="w-full h-full object-cover rounded-full" />
                </div>
                <div className="absolute w-12 h-12 rounded-full border-4 border-white bg-gray-100 flex items-center justify-center overflow-hidden" style={{ left: '40px', zIndex: 1 }}>
